...
const UserProfile = ({
  ...
  const getLifePath = () => {
    if (userProfile.lifePath === 1) {
      ...
      h5.className="bg-white shadow-purple-700 border-purple-800 border-4 shadow-2xl shadow-blue-500/90 text-purple-800 absolute top-28 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-20 pb-20 rounded-lg"
      h5.id="background"
      ...
      const h5 = document.createElement("h5");
      h5.className="bg-white drop-shadow-lg 	shadow-purple-700 border-purple-800 border-4 shadow-2xl shadow-blue-500/60 text-purple-800 absolute top-28 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-20 pb-20 rounded-lg"
      ...
      const h5 = document.createElement("h5");
      h5.className=" bg-white drop-shadow-lg shadow-purple-700border-purple-800 border-4 shadow-2xl shadow-blue-500/60 text-purple-800 absolute top-28 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-20 pb-20 rounded-lg"
      ...
      const h5 = document.createElement("h5");
      h5.className="bg-white drop-shadow-lg 	shadow-purple-700 border-purple-800 border-4 shadow-2xl shadow-blue-500/60 text-purple-800 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-20 pb-20 rounded-lg z-20"
      h5.id="userProfile"
      ...
      const h5 = document.createElement("h5");
      h5.className="bg-white drop-shadow-lg 	shadow-purple-700 border-purple-800 border-4 text-purple-800 shadow-2xl shadow-blue-500/60 absolute top-28 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-20 pb-20 rounded-lg"
  ...
  return (
    ...
    <div className="">
            ...
            <button onClick={handleShow} className="btn btn-success btn-block z-50 absolute left-96 top-4 border-4 border-white">
              ...
              <>
              <div id="no-prof-div" className="z-20 border-b-4 border-t-4 border-indigo-700 absolute top-72 mt-72 h-20 mb-2 bg-white w-screen bg-cover"></div>
              <h3 id="no-profs"className="font-bold absolute left-20 ml-6  text-92 mt-20 pt-96 pb-2 top-68 z-40 opacity-10">No other profiles</h3>
              </>
            )}
        <div id="sun-shadow">
        <img src="https://i.ibb.co/J5Wp1bd/27.png" alt="26" id="sun-img" className="absolute top-20 pt-14 right-62 drop-shadow-xl shadow-indigo-800 z-0 scale-125" />
        </div>
