...
const UserProfile = ({
  ...
  const getLifePath = () => {
    if (userProfile.lifePath === 1) {
      ...
      h5.className="bg-white shadow-purple-700 border-purple-800 border-4 shadow-2xl shadow-blue-500/90 text-purple-800 absolute top-40 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-16 pb-20 rounded-lg"
      h5.id="background"
      ...
      const h5 = document.createElement("h5");
      h5.className="bg-white drop-shadow-lg 	shadow-purple-700 border-purple-800 border-4 shadow-2xl shadow-blue-500/60 text-purple-800 absolute top-40 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-16 pb-20 rounded-lg"
      ...
      const h5 = document.createElement("h5");
      h5.className=" bg-white drop-shadow-lg shadow-purple-700border-purple-800 border-4 shadow-2xl shadow-blue-500/60 text-purple-800 absolute top-40 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-16 pb-20 rounded-lg"
      ...
      const h5 = document.createElement("h5");
      h5.className="bg-white drop-shadow-lg 	shadow-purple-700 border-purple-800 border-4 shadow-2xl shadow-blue-500/60 text-purple-800 absolute top-40 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-16 pb-20 rounded-lg z-20"
      ...
      const h5 = document.createElement("h5");
      h5.className="bg-white drop-shadow-lg 	shadow-purple-700 border-purple-800 border-4 text-purple-800 shadow-2xl shadow-blue-500/60 absolute top-40 ml-60 left-72 w-1/3 overflow-y-auto h-2/5 p-4 mt-10 pb-20 rounded-lg"
  ...
  return (
    ...
    <div className="">
            ...
            <div
            className="z-20 absolute left-20   drop-shadow-lg bg-white	 shadow-xl shadow-blue-500/90 p-10 rounded-lg top-28 mt-28 profile-container border-purple-700 border-4"
            >
            ...
            <button onClick={handleShow} className="btn btn-success btn-block absolute mb-6 top-96  mt-52 pt-2 left-96 z-40">
              Add Profile
            </button>
              ...
              <>
              <div id="no-prof-div" className="z-20 border-b-8 border-t-8 border-indigo-300 absolute top-72 mt-72 h-20 mb-2 bg-white w-screen bg-cover"></div>
              <h3 id="no-profs"className="font-bold absolute left-20 ml-6  text-92 mt-20 pt-96 pb-2 top-68 z-40">No other profiles</h3>
              </>
            )}
        
        <img src="https://i.ibb.co/J5Wp1bd/27.png" alt="26" id="sun-img" className="absolute top-20 pt-14 pl-4 right-0  drop-shadow-xl shadow-indigo-800" />
